...
namespace AgenaTrader.UserCode
{
    ...
    public class Example_Indicator_SMA_CrossOver_Advanced : UserIndicator
    {
        ...
        protected override void OnInit()
        {
            ...
            Add(new OutputDescriptor(this.Plot0Color, "SMA_CrossOver_Entry"));
            Add(new OutputDescriptor(this.Plot1Color, "SMA_CrossOver_Exit"));
        ...
        protected override void OnCalculate()
        {
            ...
            //    {
            //        case OrderDirection.Buy:
            //            AddChartDiamond("ArrowShort_Exit" + Bars[0].Time.Ticks, true, Bars[0].Time, Bars[0].Open, Color.Orange);
            //            break;
            //        case OrderDirection.Sell:
            //            AddChartDot("ArrowLong_Exit" + Bars[0].Time.Ticks, true, Bars[0].Time, Bars[0].Open, Color.Orange);
            //            break;
            //    }
            //}
