...
namespace AgenaTrader.UserCode
{
	...
	{
		/// <summary>
		/// Trend Gewinn-Stopp Trend 1
		/// </summary>
		public MyP3_Stopp_T1 MyP3_Stopp_T1(System.Int32 tick_Abstand_vom_Bar, System.Int32 toleranz_InsideBars, System.Double profit_Promille)
        {
			return MyP3_Stopp_T1(InSeries, tick_Abstand_vom_Bar, toleranz_InsideBars, profit_Promille);
		}

		/// <summary>
		/// Trend Gewinn-Stopp Trend 1
		/// </summary>
		public MyP3_Stopp_T1 MyP3_Stopp_T1(IDataSeries input, System.Int32 tick_Abstand_vom_Bar, System.Int32 toleranz_InsideBars, System.Double profit_Promille)
		{
			var indicator = CachedCalculationUnits.GetCachedIndicator<MyP3_Stopp_T1>(input, i => i.Tick_Abstand_vom_Bar == tick_Abstand_vom_Bar && i.Toleranz_InsideBars == toleranz_InsideBars && Math.Abs(i.Profit_Promille - profit_Promille) <= Double.Epsilon);

			if (indicator != null)
				return indicator;

			indicator = new MyP3_Stopp_T1
						{
	...
	public partial class UserStrategy
	{
		...
		public MyP3_Stopp_T1 MyP3_Stopp_T1(System.Int32 tick_Abstand_vom_Bar, System.Int32 toleranz_InsideBars, System.Double profit_Promille)
		{
			return LeadIndicator.MyP3_Stopp_T1(InSeries, tick_Abstand_vom_Bar, toleranz_InsideBars, profit_Promille);
		}
		...
		public MyP3_Stopp_T1 MyP3_Stopp_T1(IDataSeries input, System.Int32 tick_Abstand_vom_Bar, System.Int32 toleranz_InsideBars, System.Double profit_Promille)
		{
			...
			return LeadIndicator.MyP3_Stopp_T1(input, tick_Abstand_vom_Bar, toleranz_InsideBars, profit_Promille);
		}
	}
