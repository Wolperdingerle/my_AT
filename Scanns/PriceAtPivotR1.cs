...
namespace AgenaTrader.UserCode
{
	...
	[Category("Pivots")]
	[Description("Price at Pivot R1")]
	public class PriceAtPivotR1 : UserScan
	{
		...
		{
			LastOutput = MultiBars.GetBarsItem(TimeFrame).Close[0] >= LeadIndicator.PivotPoints(MultiBars.GetBarsItem(TimeFrame).Close, global::AgenaTrader.Custom.PivotPointsMode.Floor, global::AgenaTrader.Custom.PivotPointsRange.DayOnIntraday).R1[0];
		}
	}
}
...
<ScanWizartState xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" Advanved="false" ScanType="Short" IsEntry="false" IsStop="true" IsTarget="false" Category="Pivots" Description="Price at Pivot R1" ArrowColor="Red" TextColor="" ScanColor="" BarHighlightColor="">
  ...
  <Lexems xsi:type="ScanLexemIndicator" Serie="R1" IsFloatPoint="true" RoundToTickSize="false">
    <BarsAgo>0</BarsAgo>
