...
namespace AgenaTrader.UserCode
{
	...
	[Category("BodySize")]
	[Description("Detects Upbars with medium body size")]
	public class MediumSizeBodyGreen : UserScan
	{
		...
		protected override void OnCalculate()
		{
			LastOutput = MultiBars.GetBarsItem(TimeFrame).Close[0] > MultiBars.GetBarsItem(TimeFrame).Open[0]
				...
				&& ((MultiBars.GetBarsItem(TimeFrame).Close[0]-MultiBars.GetBarsItem(TimeFrame).Open[0])) > ((LeadIndicator.ATR(MultiBars.GetBarsItem(TimeFrame).Close, 14)[0]*1));
		}
	}
}
