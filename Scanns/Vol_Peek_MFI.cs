      ...
      <Params>
        ...
        <TAParam Name="XmlPlots" IsProperty="true">
          <Value xsi:type="ArrayOfPlot">
            <OutputDescriptor Name="Volume" PlotColor="Blue" Width="2" OutputSerieDrawStyle="Bar" PenStyle="Solid" />
          </Value>
        </TAParam>
  ...
  <Lexems xsi:type="ScanLexemIndicator" Serie="" IsFloatPoint="true">
    ...
    <XmlIndicator Name="MFI" Type="Indicator" FullTypeName="AgenaTrader.Custom.MFI">
      <Params>
        ...
        <TAParam Name="XmlPlots" IsProperty="true">
          <Value xsi:type="ArrayOfPlot">
            <OutputDescriptor Name="MFI" PlotColor="Blue" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
          </Value>
        </TAParam>
        <TAParam Name="XmlLines" IsProperty="true">
          <Value xsi:type="ArrayOfLine">
