...
{
	[UsedCalculationUnit(typeof(global::AgenaTrader.Custom.EMA), typeof(AgenaTrader.UserCode.UnusualHighVolume))]
	[ScanTypeAttribute(ScanType.Short)]
	[IsEntryAttribute(false)]
	[IsStopAttribute(true)]
	[IsTargetAttribute(false)]
	[Category("EMA34")]
	[Description("Price crosses below EMA34 with unusual high volume")]
	public class CloseBelowEMA34_increased_volume : UserScan
	{
...
<ScanWizartState xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" Advanved="false" ScanType="Short" IsEntry="false" IsStop="true" IsTarget="false" Category="EMA34" Description="Price crosses below EMA34 with unusual high volume" ArrowColor="Red" TextColor="" ScanColor="" BarHighlightColor="">
