...
{
	[UsedScans(typeof(AgenaTrader.UserCode.UKSGruenLong), typeof(AgenaTrader.UserCode.UKSRotLong))]
	...
	[Category("")]
	[Description("")]
	public class UKSatSMA200_3FallingBars : UserScan
	{
		...
		{
			LastOutput = (Math.Abs(LeadIndicator.GetCondition("UKSGruenLong")[0] - 1) <= Double.Epsilon
				|| Math.Abs(LeadIndicator.GetCondition("UKSRotLong")[0] - 1) <= Double.Epsilon)
	...
	{
		public UKSatSMA200_3FallingBars UKSatSMA200_3FallingBars()
		{
			return GetCondition<UKSatSMA200_3FallingBars>();
		}

		public UKSatSMA200_3FallingBars UKSatSMA200_3FallingBars(IDataSeries input)
		{
			return GetCondition<UKSatSMA200_3FallingBars>(input);
		}
	}
...
<ScanWizartState xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" Advanved="true" ScanType="Long" IsEntry="true" IsStop="false" IsTarget="false" Category="" Description="" ArrowColor="LawnGreen" BarHighlightColor="">
  <Lexems xsi:type="ScanLexemOpenBracket" />
  <Lexems xsi:type="ScanLexemScan">
    <BarsAgo>0</BarsAgo>
    <XmlScan Name="UKSGruenLong" Type="Scann" FullTypeName="AgenaTrader.UserCode.UKSGruenLong">
      <Params>
        ...
        <TAParam Name="Caption" IsProperty="true">
          <Value xsi:type="xsd:string">UKSGruenLong</Value>
        </TAParam>
  ...
  <Lexems xsi:type="ScanLexemScan">
    <BarsAgo>0</BarsAgo>
    <XmlScan Name="UKSRotLong" Type="Scann" FullTypeName="AgenaTrader.UserCode.UKSRotLong">
      <Params>
        <TAParam Name="InputPriceType" IsProperty="true">
          <Value xsi:type="xsd:unsignedByte">3</Value>
        </TAParam>
        ...
        <TAParam Name="Caption" IsProperty="true">
          <Value xsi:type="xsd:string">UKSRotLong</Value>
        </TAParam>
        <TAParam Name="Tags" IsProperty="true" />
      </Params>
    </XmlScan>
