      ...
      <Params>
        ...
        <TAParam Name="XmlPlots" IsProperty="true">
          <Value xsi:type="ArrayOfPlot">
            <OutputDescriptor Name="Middle" PlotColor="OrangeRed" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
            <OutputDescriptor Name="Upper" PlotColor="Navy" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
            <OutputDescriptor Name="Lower" PlotColor="Navy" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
          </Value>
        </TAParam>
  ...
  <Lexems xsi:type="ScanLexemIndicator" Serie="Default" IsFloatPoint="true">
    ...
    <XmlIndicator Name="MACD" Type="Indicator" FullTypeName="AgenaTrader.Custom.MACD">
      <Params>
        ...
        <TAParam Name="XmlPlots" IsProperty="true">
          <Value xsi:type="ArrayOfPlot">
            <OutputDescriptor Name="MACD" PlotColor="0, 128, 0" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
            <OutputDescriptor Name="Avg" PlotColor="238, 130, 238" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
            <OutputDescriptor Name="Difference" PlotColor="0, 0, 255" Width="2" OutputSerieDrawStyle="Bar" PenStyle="Solid" />
          </Value>
        </TAParam>
        <TAParam Name="XmlLines" IsProperty="true">
          <Value xsi:type="ArrayOfLine">
  ...
  <Lexems xsi:type="ScanLexemIndicator" Serie="Default" IsFloatPoint="true">
    ...
    <XmlIndicator Name="RSI" Type="Indicator" FullTypeName="AgenaTrader.Custom.RSI">
      <Params>
        ...
        <TAParam Name="XmlPlots" IsProperty="true">
          <Value xsi:type="ArrayOfPlot">
            <OutputDescriptor Name="RSI" PlotColor="0, 128, 0" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
            <OutputDescriptor Name="Avg" PlotColor="255, 69, 0" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
          </Value>
        </TAParam>
        <TAParam Name="XmlLines" IsProperty="true">
          <Value xsi:type="ArrayOfLine">
