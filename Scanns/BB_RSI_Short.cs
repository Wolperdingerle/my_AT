...
namespace AgenaTrader.UserCode
{
	...
	public class BB_RSI_Short : UserScan
	{
		...
		{
			LastOutput = MultiBars.GetBarsItem(TimeFrame).High[0] >= LeadIndicator.Bollinger(MultiBars.GetBarsItem(TimeFrame).Close, 2, 20).Upper[0]
