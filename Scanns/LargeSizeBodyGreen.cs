...
namespace AgenaTrader.UserCode
{
	...
	[Category("BodySize")]
	[Description("Detects Upbars with large body size")]
	public class LargeSizeBodyGreen : UserScan
	{
		protected override void OnInit()
		{
			...
			TextColor = null;
			ScanColor = null;
			BarHighlightColor = Color.FromArgb(255, 51, 204, 51);
		}

		protected override void OnCalculate()
		{
			LastOutput = MultiBars.GetBarsItem(TimeFrame).Close[0] > MultiBars.GetBarsItem(TimeFrame).Open[0]
				&& ((MultiBars.GetBarsItem(TimeFrame).Close[0]-MultiBars.GetBarsItem(TimeFrame).Open[0])) < ((LeadIndicator.ATR(MultiBars.GetBarsItem(TimeFrame).Close, 14)[0]*5))
