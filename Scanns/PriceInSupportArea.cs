...
namespace AgenaTrader.UserCode
{
	...
	[Description("Detects charts where the price is near a support area")]
	public class PriceInSupportArea : UserScan
	{
		...
		{
			LastOutput = MultiBars.GetBarsItem(TimeFrame).Close[0] <= (((LeadIndicator.Swing(MultiBars.GetBarsItem(TimeFrame).Close, 5).SwingLow[1]+0)+(LeadIndicator.ATR(MultiBars.GetBarsItem(TimeFrame).Close, 14)[0]*0.35)))
				&& MultiBars.GetBarsItem(TimeFrame).Close[0] >= (((LeadIndicator.Swing(MultiBars.GetBarsItem(TimeFrame).Close, 5).SwingLow[1]+0)-(LeadIndicator.ATR(MultiBars.GetBarsItem(TimeFrame).Close, 14)[0]*0.35)));
		}
	}
}
...
<ScanWizartState xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" Advanved="true" ScanType="Long" IsEntry="false" IsStop="false" IsTarget="false" Category="SupportResistance" Description="Detects charts where the price is near a support area" ArrowColor="LawnGreen" TextColor="" ScanColor="" BarHighlightColor="">
  ...
  <Lexems xsi:type="ScanLexemCalculation" RoundToTickSize="false">
    ...
    <Lexems xsi:type="ScanLexemOpenBracket" />
    <Lexems xsi:type="ScanLexemIndicator" Serie="SwingLow" IsFloatPoint="true" RoundToTickSize="false">
      <BarsAgo>1</BarsAgo>
