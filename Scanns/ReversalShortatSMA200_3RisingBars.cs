...
namespace AgenaTrader.UserCode
{
	...
	{
		public ReversalShortatSMA200_3RisingBars ReversalShortatSMA200_3RisingBars()
		{
			return GetCondition<ReversalShortatSMA200_3RisingBars>();
		}

		public ReversalShortatSMA200_3RisingBars ReversalShortatSMA200_3RisingBars(IDataSeries input)
		{
			return GetCondition<ReversalShortatSMA200_3RisingBars>(input);
		}
	}
      ...
      <Params>
        ...
        <TAParam Name="XmlPlots" IsProperty="true">
          <Value xsi:type="ArrayOfPlot">
            <Plot Name="NBarsUp" PlotColor="50, 205, 50" Width="2" PlotStyle="Bar" PenStyle="Solid" />
          </Value>
        </TAParam>
    ...
    <Lexems xsi:type="ScanLexemIndicator" Serie="" IsFloatPoint="true">
      ...
      <XmlIndicator Name="ATR" Type="Indicator" FullTypeName="AgenaTrader.Custom.ATR">
        <Params>
          ...
          <TAParam Name="XmlPlots" IsProperty="true">
            <Value xsi:type="ArrayOfPlot">
              <Plot Name="ATR" PlotColor="0, 128, 0" Width="1" PlotStyle="Line" PenStyle="Solid" />
            </Value>
          </TAParam>
          <TAParam Name="XmlLines" IsProperty="true">
            <Value xsi:type="ArrayOfLine" />
