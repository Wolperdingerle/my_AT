      ...
      <Params>
        ...
        <TAParam Name="XmlPlots" IsProperty="true">
          <Value xsi:type="ArrayOfPlot">
            <OutputDescriptor Name="Mean" PlotColor="OrangeRed" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
            <OutputDescriptor Name="Upper" PlotColor="Blue" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
            <OutputDescriptor Name="Lower" PlotColor="Blue" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
          </Value>
        </TAParam>
  ...
  <Lexems xsi:type="ScanLexemIndicator" Serie="Default" IsFloatPoint="true">
    ...
    <XmlIndicator Name="RSI" Type="Indicator" FullTypeName="AgenaTrader.Custom.RSI">
      <Params>
        ...
        <TAParam Name="XmlPlots" IsProperty="true">
          <Value xsi:type="ArrayOfPlot">
            <OutputDescriptor Name="RSI" PlotColor="Green" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
            <OutputDescriptor Name="Avg" PlotColor="OrangeRed" Width="1" OutputSerieDrawStyle="Line" PenStyle="Solid" />
          </Value>
        </TAParam>
        <TAParam Name="XmlLines" IsProperty="true">
          <Value xsi:type="ArrayOfLine">
