...
namespace AgenaTrader.UserCode
{
	...
	public class BB_RSI_3Bars_Long : UserScan
	{
		...
		{
			LastOutput = MultiBars.GetBarsItem(TimeFrame).Low[2] <= LeadIndicator.Bollinger(MultiBars.GetBarsItem(TimeFrame).Close, 2, 20).Lower[2]
				&& MultiBars.GetBarsItem(TimeFrame).Low[1] <= LeadIndicator.Bollinger(MultiBars.GetBarsItem(TimeFrame).Close, 2, 20).Lower[1]
				&& MultiBars.GetBarsItem(TimeFrame).Low[0] <= LeadIndicator.Bollinger(MultiBars.GetBarsItem(TimeFrame).Close, 2, 20).Lower[0]
